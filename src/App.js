             ...
             <Router>
               <div className='Fan-nav'>
                <div className='Fan-nav-1'>
                  ...
                  <Link onClick={this.one} to='/sy'>首页</Link>
                  <Link onClick={this.one} to='/qyb'>企业版介绍</Link>
                  <Link onClick={this.one} to='/qj'>全屋定制</Link>
                  <Link onClick={this.one} to='/cj'>橱柜工具</Link>
                  <Link onClick={this.one} to='/ding'>吊顶工具</Link>
                  <Link onClick={this.one} to='/pz'>铺砖工具</Link>
                  <Link onClick={this.one} to='/dian'>到店购</Link>
                  <Link onClick={this.one} to='/sjal'>商家案例</Link>
